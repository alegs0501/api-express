import { UsersPage } from './../interfaces/json/users-page'
...
export class UserList {
    ...
    createUser(name: string, email: string, job: string): number{
        let response = 201
    ...
    getUsers(page: number, limit: number): UsersPage{
    ...
    getUsersRange(from: number, to: number): User[]{
        const response: User[] = []
        let counter = from
